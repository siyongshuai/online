...
if($form->num_errors > 0){
   echo "<font size=\"2\" color=\"#ff0000\">".$form->num_errors." error(s) found</font>";
        ...
        <a href="#" id="loginlnk" title="登录"><img src="images/login.jpg"  style="border:0;"></a>
...
<table>
<tr><td>用户名:</td><td><input type="text" name="user" id="user" class="required" value="<?php echo $form->value("user"); ?>"></td></tr>
<tr><td>密码:</td><td><input type="password" name="pass" class="required"></td></tr>
...
<div id="footer"  ><a href="#" id="aboutlnk">&copy; 司永帅 </a></div>
</body>
</html>
